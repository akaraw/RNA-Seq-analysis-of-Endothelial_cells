...
--wait-for-files /gpfs1/scratch/30days/uqakaraw/76.RNAseq_Infection/duck/.snakemake/tmp.13s2bnuy /30days/uqakaraw/FASTQDIR_never_DELETE/duck/duckinfected03_1.fastq.gz /30days/uqakaraw/FASTQDIR_never_DELETE/duck/duckinfected03_2.fastq.gz fastqc/duckinfected03/duckinfected03_1_fastqc.zip fastqc/duckinfected03/duckinfected03_2_fastqc.zip --latency-wait 5 \
 --attempt 1 --force-use-threads \
--wrapper-prefix https://github.com/snakemake/snakemake-wrappers/raw/ \
   --allowed-rules rcorrector --nocolor --notemp --no-hooks --nolock \
--mode 2  --use-conda  --conda-prefix /30days/uqakaraw/snakemake_envs/  && touch "/gpfs1/scratch/30days/uqakaraw/76.RNAseq_Infection/duck/.snakemake/tmp.13s2bnuy/55.jobfinished" || (touch "/gpfs1/scratch/30days/uqakaraw/76.RNAseq_Infection/duck/.snakemake/tmp.13s2bnuy/55.jobfailed"; exit 1)
